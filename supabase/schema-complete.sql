-- Script SQL complet pour créer toute la base de données
...
-- Create Courses table (DOIT être créée AVANT incidents)
...
-- Create Incidents table (après courses)
...
-- Insert default courses (DOIT être fait AVANT d'insérer des incidents)
...
-- Enable Realtime (optionnel - décommentez si nécessaire)
